 ...
 * AgentTransactions
 *
 * @ORM\Table(name="agent_transactions", uniqueConstraints={@ORM\UniqueConstraint(name="transaction_id", columns={"transaction_id"})})
 * @ORM\Entity
*@ORM\Entity(repositoryClass="App\Repository\AgentTransactionsRepository")
 */
